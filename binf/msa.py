...
class MSA:
    ...
    def __init__(self, file):
        ...
        Function reads this file and store information accesible as 'align' property.
        :param file: name of a file containing data
        """
        self.align = AlignIO.read(file, "clustal")

    def get_seq_by_position(self, position):
        """
    ...
    def get_column_score(self, column, matrix=Align.substitution_matrices.load('PAM250'), gap=1):
        """
    ...
    def get_score(self, matrix=Align.substitution_matrices.load('BLOSUM62'), gap=1):
        """
    ...
    def get_conservation_scores(self, sequence, matrix=Align.substitution_matrices.load('BLOSUM62')):
        """
        ...
        for i in range(columns):
            ...
            scores.append((round(score,3) , i))
        return scores

    def get_top_scoring_positions(self, N, matrix=Align.substitution_matrices.load('BLOSUM62'), gap=1):
        """
